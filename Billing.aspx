<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Billing.aspx.cs" Inherits="Shrikrishna.Billing" %>
                          ...
                          <center>
                             ...
                             <asp:Panel ID="Panel1" runat="server">
                                 ...
                                 <table style="width:100%;" border="1">
                                     ...
                                     <table style="width:100%;" border="1">
                                         <tr><td>Description of Goods</td>
                                         <td style="width:inherit">HSN CODE</td>
                                         <td>GST Rate</td>
                                         <td>QTY</td>
                                         <td>Units</td>
                                         <td>Rate</td>
                                         <td>Amount</td></tr>  <!-- main heding-->

                                         <tr><td><asp:Label ID="Label11" runat="server" Text="Label"></asp:Label></td>
                                         <td style="width:inherit"><asp:Label ID="Label12" runat="server" Text="Label"></asp:Label></td>
                                         ...
                                         <td><asp:Label ID="Label17" runat="server" Text="Label"></asp:Label></td></tr>  <!--1-->

                                         <tr><td><asp:Label ID="Label18" runat="server" Text="Label"></asp:Label></td>
                                         <td style="width:inherit"><asp:Label ID="Label19" runat="server" Text="Label"></asp:Label></td>
                                         ...
                                         <td><asp:Label ID="Label24" runat="server" Text="Label"></asp:Label></td></tr>            <!--2-->
                                         ...
                                         <tr><td colspan ="6">Description of Goods</td>
